...
15. **Il consulente a parole sul chiosco** (`13-consulente.md`): il cliente racconta cosa cerca scrivendo, a voce o toccando degli spunti. Va bene una tastiera sul chiosco, o preferisce solo voce e spunti? O lo vuole solo per il commesso? *Ipotesi: voce e spunti in primo piano, tastiera disponibile; si decide dopo la prova in negozio.*
16. **La voce**: il riconoscimento vocale di Safari può mandare l'audio ad Apple quando l'iPad non lo fa in locale. Va bene, con un cartellino che lo dice, o si tiene spento il microfono? *Ipotesi: acceso, perché gli spunti restano sempre un'alternativa; niente viene salvato dal consulente.*
17. **Il lessico**: le oltre ottocento scene (luoghi, cibi, bevande, ricordi…) sono una prima stesura. Chi del personale può rileggerle, almeno quelle più chieste, e segnare gli accostamenti che non convincono? *Ipotesi: si rileggono dal backoffice le scene che compaiono nelle statistiche, a partire dalle prime venti.*
